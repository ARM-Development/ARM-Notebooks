"""
script to calculate bias, correlation coefficient and RMSE for two data
...
outfile = figpath+'statistics_CN10_E3SMv2_'+site+'_'+IOP+'.txt'
calc.bias_corrcoef_RMSE(ncn10_e3sm2, cpc10, outfile=outfile,label1='E3SMv2', label2='CPC')