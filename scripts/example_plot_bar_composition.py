...
datagroup1 = [org,so4,nh4,no3,chl, [], []]
datagroup2 = [org_m, so4_m, [], [], [], bc_m, dst_m]
dataall=[datagroup1, datagroup2,]
labelall = ['Organic', 'SO$_4$', 'NH$_4$', 'NO$_3$', 'Chl', 'BC', 'Dust']
colorall = ['limegreen', 'red', 'lightblue', 'orange', 'cyan', 'k', 'silver']
fig,ax = plot.bar(dataall, datalabel=['Obs','E3SMv1',], xlabel=None, ylabel='unit: $\mu$g/m$^3$', 
