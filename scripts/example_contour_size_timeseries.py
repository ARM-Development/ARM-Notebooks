...
fig,ax = plot.timeseries_size([time, time], [size_smps, np.arange(1,3001)], [smpsall.data.T, ncn_e3sm2.data.T], 
                        legend = ['SMPS','E3SMv2'], xlabel='Time', ylabel='Diameter (nm)', ylimit=(3,1000),
